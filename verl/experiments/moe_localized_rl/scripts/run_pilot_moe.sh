#!/usr/bin/env bash
# MoE-Localized RL Pilot v2: MoE-only GSPO on OLMoE + MATH.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-olmoe_gspo_moe_math_seed0}
OUTPUT_DIR=${OUTPUT_DIR:-/mnt/vast/home/ym56kacy/jinhe/MendelGM/wom/outputs/pilot_v2_moe}
...
ACTOR=(
    ...
    # Only save model weights, not optimizer state (saves ~55GB per checkpoint)
