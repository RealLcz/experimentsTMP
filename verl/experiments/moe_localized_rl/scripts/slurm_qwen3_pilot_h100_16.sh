...
#
# Qwen3-30B-A3B RSPO pilot on 16x H100 (2 nodes x 8 GPUs).
# Usage:
#   sbatch --job-name=workingA slurm_qwen3_pilot_h100_16.sh attention_only
#   sbatch --job-name=workingF slurm_qwen3_pilot_h100_16.sh full
...
exec bash "$SCRIPT_ROOT/slurm_qwen3_pilot.sh" "${1:-attention_only}"
