#!/usr/bin/env bash
# MoE-Localized RL Pilot v2: Full GSPO on OLMoE + MATH.
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-olmoe_gspo_full_math_seed0}
OUTPUT_DIR=${OUTPUT_DIR:-/mnt/vast/home/ym56kacy/jinhe/MendelGM/wom/outputs/pilot_v2_full}
